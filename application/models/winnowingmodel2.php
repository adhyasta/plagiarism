<?php
	class Winnowingmodel2 extends CI_Model{
        ...
        public function getselect($selected){
            ...
            $query = $this->db->query("SELECT `nama`, `judul`, `text`, `date_upload` FROM `filebanknazief` WHERE `id` = ?", array($selected));
		...
		public function uploadData($data){
			...
			return $this->db->insert('filebanknazief', $data);
		}
