...
<div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                ...
                <form action="<?php echo base_url(); ?>upload2/similarity2" method="post" enctype="multipart/form-data">
                <table class = "table">
                    <tr>
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td class ="col-lg-5"><textarea disabled class="form-control" rows="5" name ="cleantext" id="cleantext"><?php echo implode('|', $w->GetRollingHashFirst() );?></textarea></td></textarea>
                    </tr>
                    <tr>
                        <td class ="col-lg-5"><label for="usr">Fingerprint Dokumen Anda</label></td>
                        <td class ="col-lg-7"><textarea disabled class="form-control" rows="5" id="comment"><?php echo implode(' | ', $w->GetFingerprintsFirst() );?></textarea></td>
                    </tr>
                    <tr>
                ...
                <table class = "table" id="storage">
                    ...
                    <?php $i++;endforeach; ?>
                       ...
                       <a href="<?php echo site_url('upload2/status'); ?> " class="btn btn-block btn-danger"> <span class="glyphicon glyphicon-circle-arrow-left"></span> Back</a> 
                </form>
            </div>
        </div>
    </div>
    ...
    $(document).ready(function(){
        $("#save").click(function(){
            $.post("<?php echo base_url(); ?>upload2/simpandata",
            function(){
