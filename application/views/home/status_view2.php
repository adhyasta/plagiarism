<div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                ...
                <form action="<?php echo base_url(); ?>upload2/newCheckSimiliarity" method="post" enctype="multipart/form-data">
    			<table class = "table">
                    <tr>
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <a href="<?php echo base_url('upload2'); ?> " class="btn btn-block btn-danger"> <span class="glyphicon glyphicon-circle-arrow-left"></span> Back</a> 
