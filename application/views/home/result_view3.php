...
<div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                ...
                <form action="<?php echo base_url(); ?>upload3/similarity2" method="post" enctype="multipart/form-data">
                <table class = "table">
                    <tr>
                ...
                <table class = "table" id="storage">
                    ...
                    <?php $i++;endforeach; ?>
                       ...
                       <a href="<?php echo site_url('upload3/status'); ?> " class="btn btn-block btn-danger"> <span class="glyphicon glyphicon-circle-arrow-left"></span> Back</a> 
                </form>
            </div>
        </div>
    </div>
    ...
    $(document).ready(function(){
        $("#save").click(function(){
            $.post("<?php echo base_url(); ?>upload3/simpandata",
            function(){
