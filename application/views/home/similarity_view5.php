<div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                ...
                <a href="<?php echo base_url('upload3/status'); ?> " class="btn btn-block btn-success"><span class="glyphicon glyphicon-circle-arrow-left"></span>  Input N-Gram Lain</a>
                <button type="button" class="btn btn-info btn-block" id="save"><span class="glyphicon glyphicon-file"></span> Save</button>
                <a href="<?php echo base_url('upload3/result'); ?> " class="btn btn-block btn-danger"> <span class="glyphicon glyphicon-circle-arrow-left"></span> Back</a> 
            </div>
        </div>
    </div>
    <script>
